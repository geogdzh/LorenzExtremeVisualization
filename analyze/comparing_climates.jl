...
ax = Axis(fig[1, 1]; xlabel="Time", ylabel="z", ylabelsize=28, xlabelsize=28, yticklabelsize=24, xticklabelsize=24)
...
axislegend(ax, [elem_1, elem_2, elem_3], ["A", "B", "C"], position=:lt, labelsize=24)
